const apiInfo = {
  ...
  version: "1.0.0",
  description:
    "Учебный read API с узнаваемыми сущностями Warhammer 40,000 и едиными query-правилами.",
...
const featuredQueries = [
  ...
  },
  {
    ...
    description:
      "Показывает institutional participation для campaign dashboards и timeline analytics.",
...
const queryGuide = {
  params: [
    ...
    {
      name: "search",
      example: "search=guilliman",
      description: "Поиск по текстовым полям с ранжированием по релевантности.",
    },
    {
      name: "sort",
      example: "sort=-powerLevel,name",
      description: "Сортировка по одному или нескольким полям.",
    },
    {
      name: "filter[...]",
      example: "filter[faction]=ultramarines",
      description: "Структурированные фильтры.",
    },
    {
      name: "include",
      example: "include=faction,race,events",
      description: "Связанные сущности в блоке included.",
    },
    {
      name: "fields[...]",
      example: "fields[characters]=id,name,slug",
      description: "Выборка только нужных полей.",
    },
    {
      name: "depth",
      example: "depth=2",
      description: "Глубина обхода для `explore/graph`.",
    },
    {
      name: "maxDepth",
      example: "maxDepth=4",
      description: "Максимальная глубина traversal для `explore/path`.",
    },
    {
      name: "limitPerRelation",
      example: "limitPerRelation=6",
      description: "Лимит соседних узлов или связей на одно отношение.",
    },
    {
      name: "backlinks",
  ...
  responseShapes: {
    list: {
      ...
      links: {
        self: "/api/v1/characters?page=1&limit=12",
        next: "/api/v1/characters?page=2&limit=12",
      },
  ...
  scenarios: [
    ...
    },
    {
      ...
      description:
        "Удобный compare endpoint для squad cards, table view и армейских экспериментов.",
      path: "/api/v1/compare/units?ids=terminator-squad,intercessor-squad&include=factions,weapons,keywords",
    },
    {
    ...
    },
    {
      ...
      description:
        "Показывает, как compare работает и для system-level сущностей без power-метрики.",
      path: "/api/v1/compare/star-systems?ids=sol-system,macragge-system&include=planets,era",
    },
    {
    ...
    },
    {
      title: "Path finder",
      description:
        "Возвращает кратчайшую цепочку между двумя сущностями по текущему relation graph.",
    ...
    },
    {
      ...
      description:
        "Показывает, как строить route list, sector map и travel-aware UI поверх отдельных систем.",
    ...
    },
    {
      ...
      description:
        "Дает tactical drill-down для campaign pages, graph traversal и search-driven exploration.",
...
const concurrencyExample = {
  ...
  description:
    "Несколько endpoint-ов грузятся параллельно, а клиент объединяет результат в один экран.",
  endpoints: [
...
const dataset = {
  eras: [
    {
      ...
      slug: "great-crusade",
      name: "Great Crusade",
      summary: "Экспансия Imperium.",
      description: "Объединение миров человечества.",
      status: "historical",
      yearLabel: "M30",
      yearOrder: 30000,
      keywords: ["imperium", "expansion"],
    },
    {
      id: 2,
      slug: "horus-heresy",
      name: "Horus Heresy",
      summary: "Гражданская война примархов.",
      description: "Крупнейший раскол в истории Imperium.",
      status: "historical",
      yearLabel: "M31",
      yearOrder: 31000,
      keywords: ["civil-war", "chaos"],
    },
    {
      id: 3,
      slug: "age-of-imperium",
      name: "Age of Imperium",
      summary: "Долгий период войны и стагнации.",
      description: "Эпоха выживания после Ереси.",
      status: "historical",
      yearLabel: "M32-M41",
      yearOrder: 41000,
      keywords: ["imperium", "decline"],
    },
    {
      id: 4,
      slug: "indomitus-era",
      name: "Indomitus Era",
      summary: "Современный этап после падения Cadia.",
      description: "Эра реформ и контрнаступления.",
      status: "active",
      yearLabel: "M42",
      yearOrder: 42000,
      keywords: ["indomitus", "modern"],
    },
  ],
  races: [
    {
      ...
      slug: "human",
      name: "Human",
      summary: "Основной вид Imperium.",
      description: "Люди составляют основу множества армий и институтов.",
      status: "active",
      alignment: "mixed",
      keywords: ["imperium", "chaos", "mankind"],
    },
    {
      id: 2,
      slug: "aeldari",
      name: "Aeldari",
      summary: "Древний вид с сильной связью с варпом.",
      description: "Немногочисленный, но очень влиятельный вид.",
      status: "active",
      alignment: "xenos",
      keywords: ["psychic", "craftworlds"],
    },
    {
      id: 3,
      slug: "ork",
      name: "Ork",
      summary: "Воинственная зелёная биомасса.",
      description: "Культура Orks строится вокруг войны.",
      status: "active",
      alignment: "xenos",
      keywords: ["waaagh", "clans"],
    },
    {
      id: 4,
      slug: "necron",
      name: "Necron",
      summary: "Бессмертные машинные династии.",
      description: "Древние правители возвращаются к войне.",
      status: "active",
      alignment: "xenos",
      keywords: ["dynasties", "ancient"],
    },
    {
      id: 5,
      slug: "tyranid",
      name: "Tyranid",
      summary: "Хищный коллективный вид.",
      description: "Hive Fleets поглощают целые миры.",
      status: "active",
      alignment: "xenos",
      keywords: ["hive-fleets", "biomass"],
    },
    {
      id: 6,
      slug: "tau",
  ...
  planets: [
    {
      ...
      slug: "terra",
      name: "Terra",
      summary: "Тронный мир человечества.",
      description: "Политическое сердце Imperium.",
      status: "active",
      type: "throneworld",
      sector: "Sol",
      eraId: 4,
      starSystemId: 1,
      keywords: ["imperium", "throneworld"],
    },
    {
      id: 2,
      slug: "mars",
      name: "Mars",
      summary: "Кузница Mechanicus.",
      description: "Источник технологий и верфей.",
      status: "active",
      type: "forge-world",
      sector: "Sol",
      eraId: 4,
      starSystemId: 1,
      keywords: ["mechanicus", "forge"],
    },
    {
      id: 3,
      slug: "cadia",
      name: "Cadia",
      summary: "Легендарный мир-крепость.",
      description: "Символ стойкости Imperium.",
      status: "fallen",
      type: "fortress-world",
      sector: "Cadian Gate",
      eraId: 4,
      starSystemId: 2,
      keywords: ["imperium", "fortress"],
    },
    {
      id: 4,
      slug: "macragge",
      name: "Macragge",
      summary: "Домашний мир Ultramarines.",
      description: "Центр Ultramar и пример дисциплины.",
      status: "active",
      type: "civilized-world",
      sector: "Ultramar",
      eraId: 4,
      starSystemId: 3,
      keywords: ["ultramarines", "ultramar"],
    },
    {
      id: 5,
      slug: "armageddon",
      name: "Armageddon",
      summary: "Индустриальный мир бесконечных войн.",
      description: "Хороший пример многостороннего конфликта.",
      status: "active",
      type: "hive-world",
      sector: "Armageddon Sector",
      eraId: 4,
      starSystemId: 4,
      keywords: ["industrial", "warzone"],
    },
    {
      id: 6,
      slug: "fenris",
      name: "Fenris",
      summary: "Суровый ледяной мир.",
      description: "Показывает роль homeworld в идентичности фракции.",
      status: "active",
      type: "death-world",
      sector: "Fenris System",
      eraId: 4,
      starSystemId: 5,
      keywords: ["space-wolves", "death-world"],
    },
    {
      id: 7,
      slug: "baal",
      name: "Baal",
      summary: "Родной мир Blood Angels.",
      description: "Мир выживания и наследия.",
      status: "active",
      type: "radiated-world",
      sector: "Baal System",
      eraId: 4,
      starSystemId: 6,
      keywords: ["blood-angels", "imperium"],
    },
  ],
  starSystems: [
    {
    ...
    },
    {
      ...
      segmentum: "Segmentum Obscurus",
      eraId: 4,
      keywords: ["space-wolves", "frontier"],
    },
    {
      id: 6,
      slug: "baal-system",
  ...
  warpRoutes: [
    {
      ...
      stabilityLevel: 88,
      transitTimeRating: 74,
      fromStarSystemId: 1,
      toStarSystemId: 3,
      eraId: 4,
      factionIds: [1, 2],
      campaignIds: [1],
      keywords: ["indomitus", "logistics"],
    },
    {
      id: 2,
      ...
      stabilityLevel: 41,
      transitTimeRating: 58,
      fromStarSystemId: 1,
      toStarSystemId: 2,
      eraId: 4,
      factionIds: [1, 3, 9],
      campaignIds: [5],
      keywords: ["cadia", "chaos"],
    },
    {
      id: 3,
      slug: "armageddon-supply-run",
      name: "Armageddon Supply Run",
      summary: "Стабильный маршрут снабжения к Armageddon.",
      description:
        "Подходит для defense dashboards, convoy concepts и campaign-focused route screens.",
      status: "active",
      routeType: "supply-line",
      stabilityLevel: 76,
      transitTimeRating: 69,
      fromStarSystemId: 1,
      toStarSystemId: 4,
      eraId: 3,
      factionIds: [1, 9],
      campaignIds: [2],
      keywords: ["supply", "guard"],
    },
    {
      id: 4,
      ...
      stabilityLevel: 63,
      transitTimeRating: 62,
      fromStarSystemId: 1,
      toStarSystemId: 6,
      eraId: 4,
      factionIds: [1, 10],
      campaignIds: [3],
      keywords: ["defense", "relief"],
    },
    {
      id: 5,
      ...
      stabilityLevel: 29,
      transitTimeRating: 35,
      fromStarSystemId: 2,
      toStarSystemId: 3,
      eraId: 4,
      factionIds: [1, 6],
      campaignIds: [4],
      keywords: ["ancient", "null-zone"],
    },
  ],
  factions: [
    {
      ...
      summary: "Гигантская человеческая империя.",
      description: "Объединяет бесчисленные миры и армии.",
      status: "active",
      alignment: "imperium",
      raceIds: [1],
      homeworldId: 1,
    ...
    },
    {
      ...
      slug: "ultramarines",
      name: "Ultramarines",
      summary: "Образцовый chapter Space Marines.",
      description: "Удобная фракция для базовых frontend-упражнений.",
      status: "active",
      alignment: "imperium",
      parentFactionId: 1,
      raceIds: [1],
      ...
      eraId: 4,
      leaderIds: [2],
      keywords: ["space-marines", "ultramar"],
      powerLevel: 93,
    },
    {
      id: 3,
      slug: "black-legion",
      name: "Black Legion",
      summary: "Крупная ударная сила Chaos.",
      description: "Хорошо подходит для compare и событий Fall of Cadia.",
      status: "active",
      alignment: "chaos",
      raceIds: [1],
      eraId: 4,
      leaderIds: [4],
      keywords: ["chaos", "traitor-legion"],
      powerLevel: 94,
    },
    {
      id: 4,
      slug: "aeldari",
      name: "Aeldari",
      summary: "Древняя цивилизация.",
      description: "Полезна для тем древности и дальновидности.",
      status: "active",
      alignment: "xenos",
      raceIds: [2],
      eraId: 4,
      leaderIds: [6],
      keywords: ["craftworlds", "psychic"],
      powerLevel: 88,
    },
    {
      id: 5,
      slug: "orks",
      name: "Orks",
      summary: "Масса кланов и постоянная война.",
      description: "Яркий xenos-полюс учебного набора.",
      status: "active",
      alignment: "xenos",
      raceIds: [3],
      eraId: 4,
    ...
    },
    {
      ...
      slug: "necrons",
      name: "Necrons",
      summary: "Древние машинные династии.",
      description: "Усиливают слой данных про эпохи и мощь.",
      status: "active",
      alignment: "xenos",
      raceIds: [4],
      eraId: 4,
    ...
    },
    {
      ...
      slug: "tau-empire",
      name: "T'au Empire",
      summary: "Технологичная ксенос-держава.",
      description: "Пример молодого и рационального игрока.",
      status: "active",
      alignment: "xenos",
      raceIds: [6],
      eraId: 4,
    ...
    },
    {
      ...
      summary: "Воинствующий религиозный орден.",
      description: "Фракция с яркой верой и символикой.",
      status: "active",
      alignment: "imperium",
      parentFactionId: 1,
      raceIds: [1],
    ...
    },
    {
      ...
      summary: "Массовая армия Imperium.",
      description: "Удобна для сценариев про кампании и оборону.",
      status: "active",
      alignment: "imperium",
      parentFactionId: 1,
      raceIds: [1],
    ...
    },
    {
      ...
      slug: "blood-angels",
      name: "Blood Angels",
      summary: "Знаменитый chapter Space Marines.",
      description: "Расширяет набор homeworld-ов и событий.",
      status: "active",
      alignment: "imperium",
      parentFactionId: 1,
      raceIds: [1],
  ...
  keywords: [
    {
      ...
      slug: "infantry",
      name: "Infantry",
      description: "Пешие подразделения для базовых и массовых боевых ролей.",
      category: "battlefield-role",
    },
    {
      id: 2,
      slug: "elite",
      name: "Elite",
      description: "Элитные подразделения и оружие с повышенной ценностью.",
      category: "battlefield-role",
    },
    {
      id: 3,
      slug: "ranged",
      name: "Ranged",
      description: "Акцент на дистанционный бой и огневое давление.",
    ...
    },
    {
      ...
      slug: "melee",
      name: "Melee",
      description: "Акцент на ближний бой, натиск и захват темпа.",
      category: "combat-style",
    },
    {
      id: 5,
      slug: "psychic",
      name: "Psychic",
      description: "Связь с варпом, психосилами и аномальными эффектами.",
      category: "specialism",
    },
    {
      id: 6,
      slug: "siege",
      name: "Siege",
      description: "Осады, подавление укреплений и тяжелое наступление.",
      category: "warfare",
    },
    {
      id: 7,
      slug: "faith",
      name: "Faith",
      description: "Религиозная доктрина и мотивы святой войны.",
      category: "doctrine",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      slug: "rapid-fire",
      name: "Rapid Fire",
      description: "Высокая плотность стрельбы и быстрый темп огня.",
    ...
    },
    {
      ...
      slug: "bolt",
      name: "Bolt",
      description: "Болтерное семейство вооружения Imperium.",
    ...
    },
    {
      ...
      slug: "gauss",
      name: "Gauss",
      description: "Гаусс-технологии Necrons и их разборные лучевые эффекты.",
      category: "weapon-family",
    },
    {
      id: 13,
    ...
    },
    {
      ...
      slug: "heavy",
      name: "Heavy",
      description: "Тяжелое вооружение и отряды огневой поддержки.",
      category: "battlefield-role",
    },
  ],
  weapons: [
    ...
    },
    {
      ...
      slug: "storm-bolter",
      name: "Storm Bolter",
      summary: "Компактное болтерное оружие с высоким темпом огня.",
      description: "Подходит для elite units и учебных сценариев с rapid fire.",
      status: "active",
      weaponType: "storm-bolter",
      powerLevel: 78,
      factionId: 1,
      eraId: 4,
      keywordIds: [2, 3, 9, 11],
    ...
    },
    {
      ...
      slug: "power-sword",
      name: "Power Sword",
      summary: "Энергетический клинок для elite боевых ролей.",
      description: "Связывает melee, elite и технологическое превосходство.",
      status: "active",
    ...
    },
    {
      ...
      slug: "heavy-bolter",
      name: "Heavy Bolter",
      summary: "Тяжелое bolter-оружие огневой поддержки.",
      description: "Подходит для siege и heavy support сценариев.",
      status: "active",
      weaponType: "heavy-weapon",
      powerLevel: 84,
      factionId: 9,
      eraId: 4,
      keywordIds: [3, 6, 11, 14],
    },
    {
      id: 6,
      slug: "gauss-flayer",
      name: "Gauss Flayer",
      summary: "Базовое гаусс-оружие Necron Warriors.",
      description: "Сильный xenos-пример для техно-ориентированных loadout-ов.",
      status: "active",
      weaponType: "gauss-rifle",
      powerLevel: 79,
      factionId: 6,
      eraId: 4,
      keywordIds: [3, 8, 10, 12],
    },
    {
      id: 7,
      slug: "shoota",
      name: "Shoota",
      summary: "Импровизированное, но опасное стрелковое оружие Orks.",
      description: "Яркий пример грубой, но рабочей xenos-инженерии.",
      status: "active",
      weaponType: "slug-thrower",
      powerLevel: 63,
      factionId: 5,
      eraId: 4,
      keywordIds: [3, 8],
    ...
    },
    {
      ...
      slug: "force-sword",
      name: "Force Sword",
      summary: "Психически усиленный клинок.",
      description: "Соединяет melee и psychic-подход в одном weapon profile.",
      status: "active",
      weaponType: "force-weapon",
      powerLevel: 85,
      factionId: 1,
      eraId: 4,
      keywordIds: [4, 5, 10],
    ...
    },
    {
      ...
      slug: "choppa",
      name: "Choppa",
      summary: "Грубое рубящее оружие Orks.",
      description: "Простой melee-инструмент для агрессивных толповых отрядов.",
      status: "active",
      weaponType: "axe",
      powerLevel: 57,
      factionId: 5,
  ...
  units: [
    ...
    },
    {
      ...
      summary: "Тяжелобронированная elite infantry.",
      description: "Удобный пример дорогого elite-отряда с богатым loadout.",
      status: "active",
      unitType: "elite-infantry",
      powerLevel: 92,
      eraId: 4,
      factionIds: [2],
      keywordIds: [1, 2, 3, 4, 14],
      weaponIds: [2, 13],
    },
    {
      id: 3,
    ...
    {
      id: 10,
      slug: "primaris-librarian",
      name: "Primaris Librarian",
      summary: "Психически одаренный specialist отряд Space Marines.",
      description: "Соединяет psychic, melee и elite-паттерны в одном объекте.",
      status: "active",
      unitType: "specialist",
      powerLevel: 88,
      eraId: 4,
  ...
  organizations: [
    ...
    {
      id: 6,
      slug: "fire-caste-command",
      name: "Fire Caste Command",
      summary: "Военный центр T'au Empire.",
      description:
        "Удобный пример military command структуры для filters и compare организационного уровня.",
      status: "active",
      organizationType: "military-command",
      influenceLevel: 79,
      eraId: 4,
      factionIds: [7],
      leaderIds: [8],
  ...
  relics: [
    ...
    },
    {
      ...
      slug: "drachnyen",
      name: "Drach'nyen",
      summary: "Пугающий демонический клинок Abaddon.",
      description: "Полезен для high-stakes detail UI и темных веток search.",
      status: "active",
      relicType: "daemon-weapon",
      powerLevel: 97,
      factionId: 3,
      bearerCharacterId: 4,
      eraId: 4,
  ...
  events: [
    {
      ...
      slug: "horus-heresy",
      name: "Horus Heresy",
      summary: "Гражданская война, сломавшая Imperium.",
      description: "Ключевой исторический узел для множества связей.",
      status: "historical",
      eraId: 2,
      yearLabel: "M31",
      yearOrder: 31000,
      ...
      factionIds: [1, 2, 3],
      characterIds: [1, 3, 4],
      keywords: ["civil-war", "primarchs"],
    },
    {
      id: 2,
      slug: "battle-of-macragge",
      name: "Battle of Macragge",
      summary: "Оборона Macragge от Tyranids.",
      description: "Эталонный пример оборонительной кампании.",
      status: "historical",
      eraId: 3,
      yearLabel: "745.M41",
      yearOrder: 41745,
      ...
      factionIds: [2, 10],
      characterIds: [2, 11],
      keywords: ["defense", "tyranids"],
    },
    {
      id: 3,
      slug: "third-war-for-armageddon",
      name: "Third War for Armageddon",
      summary: "Большая война за Armageddon.",
      description: "Удобная точка для compare Imperium и Orks.",
      status: "historical",
      eraId: 3,
      yearLabel: "998.M41",
      yearOrder: 41998,
      ...
      factionIds: [5, 9],
      characterIds: [5, 10],
      keywords: ["siege", "waaagh"],
    },
    {
      id: 4,
      slug: "fall-of-cadia",
      name: "Fall of Cadia",
      summary: "Разрушение Cadia и слом старого баланса.",
      description: "Событие с высокой ценностью для search и filters.",
      status: "historical",
      eraId: 4,
      yearLabel: "999.M41",
      yearOrder: 41999,
    ...
    {
      id: 5,
      slug: "indomitus-crusade",
      name: "Indomitus Crusade",
      summary: "Контрнаступление Imperium после возвращения Guilliman.",
      description: "Один из лучших modern-era examples.",
      status: "active",
      eraId: 4,
      yearLabel: "M42",
      yearOrder: 42000,
      planetIds: [1, 3, 4],
      factionIds: [1, 2, 8, 9, 10],
      characterIds: [2, 9, 10, 11, 12],
      keywords: ["indomitus", "crusade"],
    },
  ],
  campaigns: [
    {
      ...
      slug: "plague-wars",
      name: "Plague Wars",
      summary: "Долгая кампания за Ultramar против сил Chaos.",
      description:
        "Многоэтапный campaign resource для screens с timelines, factions и organizations.",
      status: "active",
      campaignType: "crusade",
      eraId: 4,
      yearLabel: "Early M42",
      yearOrder: 42001,
      planetIds: [4],
    ...
    {
      id: 3,
      slug: "defense-of-baal",
      name: "Defense of Baal",
      summary: "Оборонительная кампания вокруг Baal.",
      description:
        "Подходит для relation-rich campaign detail pages с chapter identity и faith motifs.",
      status: "historical",
      campaignType: "defense",
      eraId: 4,
      yearLabel: "Transition to M42",
      yearOrder: 42000,
      planetIds: [7],
      factionIds: [1, 10],
      characterIds: [2, 11],
      organizationIds: [3, 4],
      keywords: ["defense", "faith"],
    },
    {
      id: 4,
      slug: "pariah-nexus-containment",
      name: "Pariah Nexus Containment",
      summary: "Попытки сдержать давление Necron-зон подавления.",
      description:
        "Сильный учебный пример campaign-level данных про древние угрозы и технологические ответы.",
      status: "active",
      campaignType: "containment",
      eraId: 4,
      yearLabel: "Mid M42",
      yearOrder: 42003,
      planetIds: [1, 2],
      factionIds: [1, 6],
      characterIds: [2, 7],
      organizationIds: [1, 2, 5],
      keywords: ["ancient", "psychic"],
    },
    {
      id: 5,
  ...
  fleets: [
    {
      ...
      strengthRating: 95,
      currentStarSystemId: 3,
      homePortPlanetId: 4,
      eraId: 4,
      factionIds: [1, 2],
      commanderIds: [2],
      campaignIds: [1, 5],
      keywords: ["indomitus", "void-war"],
    },
    {
      id: 2,
      ...
      strengthRating: 94,
      currentStarSystemId: 2,
      eraId: 4,
      factionIds: [3],
      commanderIds: [4],
      campaignIds: [5],
      keywords: ["chaos", "crusade"],
    },
    {
      id: 3,
      slug: "armageddon-defense-flotilla",
      name: "Armageddon Defense Flotilla",
      summary: "Оборонительное соединение вокруг Armageddon.",
      description:
        "Подходит для defense dashboards и combined-arms examples с campaign drill-down.",
      status: "active",
      fleetType: "defense-flotilla",
      mobilityClass: "sector-guard",
      strengthRating: 82,
      currentStarSystemId: 4,
      homePortPlanetId: 5,
      eraId: 3,
      factionIds: [1, 9],
      commanderIds: [10],
      campaignIds: [2],
      keywords: ["defense", "guard"],
    },
    {
      id: 4,
      slug: "baal-relief-fleet",
      name: "Baal Relief Fleet",
      summary: "Флот поддержки Blood Angels во время кризиса Baal.",
      description:
        "Даёт понятный пример relief operations и связки fleet -> campaign -> battlefield.",
      status: "active",
      fleetType: "relief-fleet",
      mobilityClass: "strike-cruiser",
      strengthRating: 87,
      currentStarSystemId: 6,
      homePortPlanetId: 7,
      eraId: 4,
      factionIds: [1, 10],
      commanderIds: [2, 11],
  ...
  battlefields: [
    {
      ...
      characterIds: [2, 4],
      campaignIds: [1],
      keywords: ["void-war", "siege"],
    },
    {
      id: 2,
      slug: "hades-hive-bulwark",
      name: "Hades Hive Bulwark",
      summary: "Главный оборонительный пояс Armageddon.",
      description:
        "Учебный пример battlefield detail для defense campaign, Ork pressure и urban war.",
      status: "historical",
      battlefieldType: "fortress-line",
      terrain: "ash-hive",
      intensityLevel: 91,
      planetId: 5,
      starSystemId: 4,
      ...
      characterIds: [5, 10],
      campaignIds: [2],
      keywords: ["hive-war", "defense"],
    },
    {
      id: 3,
      slug: "angelic-redoubts",
      name: "Angelic Redoubts",
      summary: "Оборонительные бастионы вокруг Baal.",
      description:
        "Подходит для path и graph между Blood Angels, campaign и system-level навигацией.",
      status: "historical",
      battlefieldType: "redoubt-network",
      terrain: "radiated-desert",
      intensityLevel: 96,
      planetId: 7,
      starSystemId: 6,
      eraId: 4,
      ...
      characterIds: [2, 11],
      campaignIds: [3],
      keywords: ["defense", "redoubts"],
    },
    {
      id: 4,
      slug: "null-bastion-corridor",
      name: "Null Bastion Corridor",
      summary: "Полоса подавления в зоне Pariah Nexus.",
      description:
        "Дает graph-связь между Necrons, containment campaign и star-system scope без обязательного planet detail.",
      status: "active",
      battlefieldType: "suppression-zone",
      terrain: "null-field",
      intensityLevel: 93,
      starSystemId: 2,
      eraId: 4,
    ...
    },
    {
      ...
      characterIds: [4, 10],
      campaignIds: [5],
      keywords: ["cadia", "counteroffensive"],
    },
    {
      id: 6,
  ...
  characters: [
    {
      ...
      summary: "Создатель Imperium.",
      description: "Фундаментальная точка отсчета для множества ресурсов.",
      status: "enthroned",
      factionId: 1,
      raceId: 1,
      homeworldId: 1,
      eraId: 3,
      eventIds: [1],
      titles: ["Master of Mankind", "Lord of the Imperium"],
      keywords: ["imperium", "psychic"],
      alignment: "imperium",
      powerLevel: 100,
    },
    {
      ...
      summary: "Primarch Ultramarines и лицо современного Imperium.",
    ...
    },
    {
      ...
      slug: "horus-lupercal",
      name: "Horus Lupercal",
      summary: "Военачальник крестового похода, ставший мятежником.",
      description: "Ключевая фигура Horus Heresy.",
      status: "dead",
      factionId: 3,
      raceId: 1,
      homeworldId: 1,
    ...
    },
    {
      ...
      summary: "Верховный лидер Black Legion.",
      description: "Связывает Chaos, Cadia и compare page.",
      status: "active",
      factionId: 3,
      raceId: 1,
      eraId: 4,
      eventIds: [1, 4],
      titles: ["Warmaster of Chaos"],
      keywords: ["chaos", "black-legion"],
      alignment: "chaos",
      powerLevel: 96,
    },
    {
      id: 5,
      slug: "ghazghkull-thraka",
      name: "Ghazghkull Thraka",
      summary: "Главный warboss современного WAAAGH!.",
      description: "Яркий xenos-лидер для фронтенд-упражнений.",
      status: "active",
      factionId: 5,
      raceId: 3,
      homeworldId: 5,
      eraId: 4,
      eventIds: [3],
      titles: ["Prophet of the Waaagh!"],
      keywords: ["orks", "waaagh"],
      alignment: "xenos",
      powerLevel: 92,
    },
    {
      ...
      slug: "eldrad-ulthran",
      name: "Eldrad Ulthran",
      summary: "Один из самых известных farseer Aeldari.",
      description: "Хороший пример древнего и дальновидного персонажа.",
      status: "active",
      factionId: 4,
      raceId: 2,
      eraId: 4,
    ...
    {
      id: 7,
      slug: "imotekh-the-stormlord",
      name: "Imotekh the Stormlord",
      summary: "Влиятельный лидер Necrons.",
      description: "Усиливает слой данных про династии и древнюю власть.",
      status: "active",
      factionId: 6,
      raceId: 4,
      eraId: 4,
      eventIds: [],
      titles: ["Phaeron of the Sautekh Dynasty"],
      keywords: ["necrons", "dynasty"],
      alignment: "xenos",
      powerLevel: 91,
    },
    {
      id: 8,
      slug: "commander-shadowsun",
      name: "Commander Shadowsun",
      summary: "Легендарный командир T'au Empire.",
      description: "Соединяет modern command structure и T'au politics.",
      status: "active",
      factionId: 7,
      raceId: 6,
      eraId: 4,
      ...
      keywords: ["tau", "greater-good"],
      alignment: "xenos",
      powerLevel: 85,
    },
    {
      id: 9,
      slug: "saint-celestine",
      name: "Saint Celestine",
      summary: "Живая святая Imperium.",
      description: "Полезна для сценариев про веру и высокие stakes.",
      status: "active",
      factionId: 8,
      raceId: 1,
      homeworldId: 1,
    ...
    {
      id: 10,
      slug: "commissar-yarrick",
      name: "Commissar Yarrick",
      summary: "Герой Astra Militarum и Armageddon.",
      description: "Удобен для конкурентных запросов к events и planets.",
      status: "legendary",
      factionId: 9,
      raceId: 1,
      homeworldId: 3,
      eraId: 4,
      eventIds: [3, 4, 5],
      titles: ["Hero of Hades Hive"],
      keywords: ["guard", "cadia"],
      alignment: "imperium",
      powerLevel: 83,
    },
    {
      ...
      slug: "dante",
      name: "Dante",
      summary: "Глава Blood Angels.",
      description: "Соединяет chapter, homeworld и крупные события.",
      status: "active",
      factionId: 10,
      raceId: 1,
      homeworldId: 7,
      eraId: 4,
      eventIds: [2, 5],
      titles: ["Chapter Master of the Blood Angels"],
      keywords: ["blood-angels", "space-marines"],
      alignment: "imperium",
      powerLevel: 88,
    },
    {
      ...
      slug: "lion-eljonson",
      name: "Lion El'Jonson",
      summary: "Primarch Dark Angels.",
      description: "Добавляет второй primarch-полюс современной эпохе.",
      status: "active",
      factionId: 1,
      raceId: 1,
      homeworldId: 1,
      eraId: 4,
      eventIds: [5],
      titles: ["Primarch of the Dark Angels"],
      keywords: ["primarch", "imperium"],
      alignment: "imperium",
      powerLevel: 95,
    },
  ],
  ...
  eras: {
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название эры." },
      {
        name: "status",
        type: "string",
        description: "Активная или историческая.",
      },
      {
        name: "yearOrder",
        type: "number",
  ...
  "star-systems": {
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название системы." },
      {
        name: "segmentum",
        type: "string",
        description: "Имперский макрорегион.",
      },
      {
        name: "planetIds",
        type: "number[]",
        description: "Миры, входящие в систему.",
      },
    ],
    sampleQueries: [
      "/api/v1/star-systems?include=planets,era&sort=name",
      "/api/v1/star-systems?filter[planets]=terra,mars",
    ],
  },
  "warp-routes": {
    label: "Варп-маршруты",
    description:
      "Маршруты между системами для maps, route planners и movement-aware API сценариев.",
    defaultSort: "-stabilityLevel,name",
    previewParams: {
      limit: 6,
      sort: "-stabilityLevel,name",
    ...
    filters: {
      ...
      fromStarSystem: {
        ...
        localField: "fromStarSystemId",
        label: "Система отправления",
      },
      toStarSystem: {
        type: "relation",
        resource: "star-systems",
        localField: "toStarSystemId",
        label: "Система назначения",
      },
      starSystems: {
        type: "relation",
        resource: "star-systems",
        localField: "starSystemIds",
        many: true,
        label: "Любая из систем маршрута",
      },
      factions: {
        type: "relation",
        resource: "factions",
        localField: "factionIds",
        many: true,
        label: "Фракции",
      },
      campaigns: {
    ...
    fields: [
      ...
      { name: "routeType", type: "string", description: "Тип варп-маршрута." },
      {
        name: "stabilityLevel",
        type: "number",
        description: "Условная метрика стабильности.",
      },
      {
        name: "transitTimeRating",
        type: "number",
        description: "Условная метрика скорости перехода.",
      },
      {
        name: "fromStarSystemId",
        type: "number",
      ...
      },
      {
        name: "toStarSystemId",
        type: "number",
        description: "Система назначения.",
      },
    ],
    sampleQueries: [
      "/api/v1/warp-routes?include=fromStarSystem,toStarSystem,factions,campaigns&sort=-stabilityLevel,name",
      "/api/v1/warp-routes?filter[starSystems]=sol-system,cadian-gate-system",
    ],
  },
  planets: {
    label: "Миры",
    ...
    filters: {
      ...
      starSystem: {
        type: "relation",
        resource: "star-systems",
        localField: "starSystemId",
        label: "Звездная система",
      },
      keywords: { type: "array", field: "keywords", label: "Keywords" },
    },
    includes: {
    ...
    fields: [
      ...
      { name: "sector", type: "string", description: "Сектор или регион." },
      {
        name: "starSystemId",
        type: "number",
        description: "Связь с системой.",
      },
    ],
    sampleQueries: [
      "/api/v1/planets?include=era,starSystem&sort=name",
      "/api/v1/planets?filter[starSystem]=sol-system",
    ],
  },
  factions: {
    label: "Фракции",
    ...
    previewParams: {
      ...
      include: "leaders,races,homeworld",
    },
    ...
    includes: {
      ...
      homeworld: {
        resource: "planets",
        localField: "homeworldId",
        label: "Родной мир",
      },
      era: { resource: "eras", localField: "eraId", label: "Эра" },
      parentFaction: {
        resource: "factions",
        localField: "parentFactionId",
        label: "Родительская фракция",
      },
    },
    fields: [
      { name: "id", type: "number", description: "Числовой идентификатор." },
      ...
      { name: "alignment", type: "string", description: "Политический полюс." },
      {
        name: "powerLevel",
        type: "number",
        description: "Условная учебная метрика.",
      },
    ],
    sampleQueries: [
      "/api/v1/factions?include=leaders,races,homeworld&sort=-powerLevel,name",
      "/api/v1/factions?filter[alignment]=imperium",
    ],
  },
  fleets: {
    label: "Флоты",
    description:
      "Навигационный и военный слой для naval dashboards, campaign logistics и graph traversal.",
    ...
    filters: {
      ...
      currentStarSystem: {
        type: "relation",
        resource: "star-systems",
        localField: "currentStarSystemId",
        label: "Текущая система",
      },
      homePort: {
        type: "relation",
        resource: "planets",
        localField: "homePortPlanetId",
        label: "Порт базирования",
      },
      keywords: { type: "array", field: "keywords", label: "Keywords" },
    },
    includes: {
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название флота." },
      {
        name: "fleetType",
        type: "string",
        description: "Роль или тип флотского соединения.",
      },
      {
        name: "mobilityClass",
        type: "string",
        description: "Характер движения и реакции.",
      },
      {
        name: "strengthRating",
        type: "number",
        description: "Условная учебная метрика силы.",
      },
      {
        name: "currentStarSystemId",
        type: "number",
        description: "Текущая система нахождения.",
      },
      {
        name: "homePortPlanetId",
        type: "number",
        description: "Мир базирования.",
      },
    ],
    sampleQueries: [
      "/api/v1/fleets?include=factions,commanders,campaigns,currentStarSystem&sort=-strengthRating,name",
      "/api/v1/fleets?filter[campaigns]=plague-wars&filter[factions]=imperium-of-man",
    ],
  },
  organizations: {
    label: "Организации",
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название организации." },
      {
        ...
        type: "string",
        description: "Вид институции или ордена.",
      },
      {
        name: "influenceLevel",
        type: "number",
        description: "Условная метрика политического или стратегического веса.",
      },
      {
        name: "factionIds",
        type: "number[]",
        description: "Связанные фракции.",
      },
      {
        name: "leaderIds",
        type: "number[]",
        description: "Лидеры или знаковые фигуры.",
      },
    ],
    sampleQueries: [
      "/api/v1/organizations?include=factions,leaders,homeworld&sort=-influenceLevel,name",
      "/api/v1/organizations?filter[faction]=imperium-of-man&filter[type]=ordo",
    ],
  },
  keywords: {
    label: "Keywords",
    ...
    fields: [
      ...
      { name: "slug", type: "string", description: "Публичный slug." },
      {
        name: "name",
        type: "string",
        description: "Отображаемое имя keyword.",
      },
      { name: "category", type: "string", description: "Категория keyword." },
    ],
    sampleQueries: [
      "/api/v1/keywords?sort=name",
      "/api/v1/keywords?filter[category]=weapon-profile",
    ],
  },
  weapons: {
    label: "Оружие",
    description:
      "Отдельный ресурс для loadout-ов, unit cards, filters по типу вооружения и tech tree UI.",
    defaultSort: "-powerLevel,name",
    previewParams: {
      limit: 8,
      sort: "-powerLevel,name",
      include: "faction,era,keywords",
    },
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название оружия." },
      {
        name: "weaponType",
        type: "string",
        description: "Категория вооружения.",
      },
      {
        name: "powerLevel",
        type: "number",
      ...
      },
      {
        name: "factionId",
        type: "number",
        description: "Связь с основной фракцией.",
      },
      {
        name: "keywordIds",
        type: "number[]",
        description: "Связь с нормализованными tags.",
      },
    ],
    sampleQueries: [
      "/api/v1/weapons?include=faction,keywords&sort=-powerLevel,name",
      "/api/v1/weapons?filter[keywords]=bolt,rapid-fire",
    ],
  },
  relics: {
    label: "Реликвии",
    description:
      "Артефакты и священные предметы для inventory UI, detail pages и relation-heavy данных.",
    defaultSort: "-powerLevel,name",
    previewParams: {
      limit: 6,
      sort: "-powerLevel,name",
      include: "faction,bearer,originPlanet,keywords",
    },
    ...
    filters: {
      ...
      bearer: {
        type: "relation",
        resource: "characters",
        localField: "bearerCharacterId",
        label: "Носитель",
      },
      originPlanet: {
        type: "relation",
        resource: "planets",
        localField: "originPlanetId",
        label: "Мир происхождения",
      },
      era: {
        type: "relation",
        resource: "eras",
    ...
    fields: [
      ...
      {
        name: "bearerCharacterId",
        type: "number",
        description: "Текущий носитель реликвии.",
      },
      {
        name: "keywordIds",
        type: "number[]",
        description: "Связанные нормализованные теги.",
      },
    ],
    sampleQueries: [
      "/api/v1/relics?include=faction,bearer,originPlanet,keywords&sort=-powerLevel,name",
      "/api/v1/relics?filter[bearer]=roboute-guilliman",
    ],
  },
  units: {
    label: "Юниты",
    description:
      "Сильный учебный ресурс для army builder, squad browser, compare cards и rich includes.",
    defaultSort: "-powerLevel,name",
    previewParams: {
      limit: 8,
      sort: "-powerLevel,name",
    ...
    fields: [
      ...
      },
      {
        name: "factionIds",
        type: "number[]",
        description: "Одна или несколько фракций.",
      },
      {
        name: "weaponIds",
        type: "number[]",
        description: "Типовые loadout-позиции.",
      },
      {
        name: "keywordIds",
        type: "number[]",
        description: "Нормализованные tags.",
      },
    ],
    sampleQueries: [
      "/api/v1/units?include=factions,weapons,keywords&sort=-powerLevel,name",
      "/api/v1/units?filter[faction]=ultramarines&filter[keywords]=elite",
    ],
  },
  events: {
    label: "События",
    ...
    previewParams: {
      limit: 5,
      sort: "-yearOrder,name",
      include: "era,planets,factions,characters",
    },
    ...
    sampleQueries: [
      "/api/v1/events?include=era,planets,factions,characters&sort=-yearOrder,name",
      "/api/v1/events?filter[era]=indomitus-era",
    ],
  },
  campaigns: {
    label: "Кампании",
    description:
      "Долгие операции и фронты для timeline explorer, dashboards и multi-resource detail pages.",
    defaultSort: "-yearOrder,name",
    previewParams: {
      limit: 5,
      sort: "-yearOrder,name",
    ...
    fields: [
      ...
      },
      {
        name: "yearOrder",
        type: "number",
        description: "Поле сортировки timeline.",
      },
      {
        name: "planetIds",
        type: "number[]",
        description: "Миры, задействованные в кампании.",
      },
      {
        name: "organizationIds",
        type: "number[]",
        description: "Организации-участники.",
      },
      {
        name: "battlefieldIds",
        type: "number[]",
        description: "Связанные поля битв.",
      },
    ],
    sampleQueries: [
      "/api/v1/campaigns?include=era,planets,factions,characters,organizations,battlefields&sort=-yearOrder,name",
      "/api/v1/campaigns?filter[battlefields]=hesperon-void-line",
    ],
  },
  battlefields: {
    label: "Поля битв",
    description:
      "Тактический слой для warzone maps, campaign drill-down и relation-heavy battlefield detail pages.",
    ...
    fields: [
      ...
      { name: "name", type: "string", description: "Название поля битвы." },
      {
        ...
        type: "string",
        description: "Категория боевой зоны.",
      },
      { name: "terrain", type: "string", description: "Тип местности." },
      {
        name: "intensityLevel",
        type: "number",
        description: "Условная метрика давления и масштаба.",
      },
      {
        name: "campaignIds",
        type: "number[]",
        description: "Кампании, проходящие через это поле битвы.",
      },
    ],
    sampleQueries: [
      "/api/v1/battlefields?include=planet,starSystem,era,factions,characters,campaigns&sort=-intensityLevel,name",
      "/api/v1/battlefields?filter[campaigns]=plague-wars,cadian-gate-counteroffensive",
    ],
  },
  characters: {
    label: "Персонажи",
    ...
    sampleQueries: [
      "/api/v1/characters?filter[faction]=ultramarines&include=faction,race,homeworld,events",
      "/api/v1/characters?search=primarch&sort=-powerLevel,name",
    ],
  },
};
